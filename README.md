...
- I feel mixed about AI, so I'm trying to use it in unique ways and without letting it take over for me.
  - I made an AI companion app called [buddyGenAI](https://github.com/parsehex/buddyGenAI)
  - I'm experimenting with [making procedural sprites using language models](https://github.com/parsehex/aAI-Art).
